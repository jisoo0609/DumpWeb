        ...
        <fieldset>
            ...
            <ul class="CarUl">
                ...
                <li>
                    ...
                    <span class="drvInputSpan"><input id="lastKm" name="lastKm" type="number" pattern="[0-9]*"
                                                      inputmode="numeric" placeholder="차량계기판의 최종 주행거리"></span>
                </li>
                <li>
                    <label class="drvLabel" for="useAmt">사용금액</label>
                    <span class="drvInputSpan"><input id="useAmt" name="useAmt" type="number" pattern="[0-9]*"
                                                      inputmode="numeric" placeholder="사용금액"></span>
                </li>
                <li>
                    <label class="drvLabel" for="useOil">주유량 L</label>
                    <span class="drvInputSpan"><input id="useOil" name="useOil" type="number" pattern="[0-9]*"
                                                      inputmode="numeric" placeholder="주유량"></span>
                </li>
                <li>
                    <label class="drvLabel">기타(설명) <span><img class="drvVoiceImg"
                                                              src="/resources/image/step5/ico_mic.png"
                                                              alt="음성인식 버튼"></span> </label>
                    <span class="drvInputSpan"><textarea placeholder="주유소 및 정비소와 수리내용" id="drvRem voiceNotification"
                                                         name="drvRem" class="voice-notification" cols="30"
            ...
            <ul class="bdnUl" id="hiddenPart">
                ...
                <li>
                    ...
                    <span class="drvInputSpan"><input name="repaddkm" id="nextlastkm" type="number" pattern=”\d*”
